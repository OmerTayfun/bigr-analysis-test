  ...
  const kategoriler = [
    ...
    },
    {
      ...
      desc: isKisiselVeri
        ...
        : isHayir ? `${q.tedbir} alanındaki kontrol eksikliği, BİGR rehberinin ${q.tedbirNo} maddesine doğrudan aykırılık teşkil etmekte ve yasal denetim süreçlerinde bulgu olarak raporlanabilir.` : `${q.tedbir} alanındaki kısmi uygulama, BİGR rehberinin ${q.tedbirNo} maddesine tam uyumu sağlamaktan uzak kalmakta ve düzenleyici otoritelerin denetiminde risk oluşturmaktadır.`
    },
    {
...
function buildDanismanKart(q) {
  ...
  if (!mevzuatHTML) {
    mevzuatHTML = `<div style="padding:10px;background:rgba(148,163,184,0.06);border-radius:7px;border:1px dashed rgba(148,163,184,0.2)"><div style="font-size:10px;font-weight:700;color:#64748b;margin-bottom:6px">📋 BİGR Kapsamı</div><div style="font-family:monospace;font-weight:700;color:#60a5fa;font-size:11px">${q.tedbirNo}</div><div style="font-size:10px;color:#475569;margin-top:5px;line-height:1.5">Bu kontrole özgü yasal mevzuat referansı tanımlanmamış olmakla birlikte, ilgili alandaki eksiklik kurumun genel bilgi güvenliği yükümlülüklerini etkileyebilir.</div></div>`;
  }
